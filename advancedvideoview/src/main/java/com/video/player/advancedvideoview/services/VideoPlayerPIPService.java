...
import com.android.manager.videoviewlibraryhelper.BasicExoPlayer;
import com.android.manager.videoviewlibraryhelper.BasicExoPlayerPIP;
import com.android.manager.videoviewlibraryhelper.R;
...
public class VideoPlayerPIPService extends Service {
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            maximum.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent1 = new Intent(getApplicationContext(), BasicExoPlayerPIP.class);
